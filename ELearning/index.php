...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to Riya Classes</h1>
        <small class="my-content">Learn New Technologies</small><br />
        <?php    
    ...
    <div class="container-fluid bg-danger"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          ...
          <div class="col-sm">
            <a class="text-white social-hover" href="https://www.instagram.com/ravish_209k/"><i class="fab fa-instagram"></i> Instagram</a>
          </div>
        </div>
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Riya Classes provides universal access to the world’s best education, and  offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Riya Classes<br> A-54, Main Road II <br> Johripur, Delhi<br> Ph. 8178965858 </p>
          </div>
        </div>
      </div>
